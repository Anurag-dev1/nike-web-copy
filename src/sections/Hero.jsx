...
const Hero = () => {
  ...
  return (
    <section id='home' className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      ...
      <p className='font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm'>Discover the new stylish Shoes that are here 
      to elevate your style and comfort this summer.
      </p>
      ...
      <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
         {statistics.map((stat,index) =>(
          <div>
            <p className='text-4xl font-palanquin font-extrabold'>{stat.value}</p>
